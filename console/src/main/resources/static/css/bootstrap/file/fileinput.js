...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tImage = '<img src="{data}" class="file-preview-img kv-preview-data" title="{title}" ' +
                'alt="{alt}"' + tStyle + '>\n';
        ...
        _getExifObj: function (data) {
            ...
            if (data.slice(0, 23) !== 'data:img/jpeg;base64,' && data.slice(0, 22) !== 'data:img/jpg;base64,') {
                exifObj = null;
                return;
            }
            try {
                ...
                reader.onload = function (theFile) {
                    ...
                    if (knownTypes === 0) {// auto detect mime types from content if no known file types detected
                        ...
                        if ($h.isEmpty(mime)) { // look for ascii text content
                            ...
                            mime = $h.isSvg(contents) ? 'img/svg+xml' : $h.getMimeType(hex, contents, file.type);
                        }
